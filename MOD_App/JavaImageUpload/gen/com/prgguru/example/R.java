        ...
        */
        ...
        /**  These attributes are meant to be specified and customized by the app.
         ...
         be present and whether it should overlay content. 
           ...
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMajor com.prgguru.example:windowFixedHeightMajor}</code></td><td> A fixed height for the window along the major axis of the screen,
             that is, when in portrait.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedHeightMinor com.prgguru.example:windowFixedHeightMinor}</code></td><td> A fixed height for the window along the minor axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMajor com.prgguru.example:windowFixedWidthMajor}</code></td><td> A fixed width for the window along the major axis of the screen,
             that is, when in landscape.</td></tr>
           <tr><td><code>{@link #ActionBarWindow_windowFixedWidthMinor com.prgguru.example:windowFixedWidthMinor}</code></td><td> A fixed width for the window along the minor axis of the screen,
             that is, when in portrait.</td></tr>
...
<p>May be a boolean value, either "<code>true</code>" or "<code>false</code>".
        ...
        */
        ...
        /** Attributes that can be used with a LinearLayoutICS.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #LinearLayoutICS_divider com.prgguru.example:divider}</code></td><td> Drawable to use as a vertical divider between buttons.</td></tr>
           <tr><td><code>{@link #LinearLayoutICS_dividerPadding com.prgguru.example:dividerPadding}</code></td><td> Size of padding on either end of a divider.</td></tr>
           <tr><td><code>{@link #LinearLayoutICS_showDividers com.prgguru.example:showDividers}</code></td><td> Setting for which dividers to show.</td></tr>
           </table>
